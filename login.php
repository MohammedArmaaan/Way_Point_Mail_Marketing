    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-indigo-200 mt-2">Welcome back! Please sign in to continue</p>
            </div>
            ...
            <div class="glass-effect bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
                ...
                <form method="POST" action="" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2">
                            ...
                            <span class="text-indigo-200 text-sm">Remember me</span>
                        </label>
                        <a href="forgot-password.php" class="text-sm text-white hover:text-indigo-300 underline">Forgot Password?</a>
                    </div>
                ...
                <p class="text-center mt-8 text-indigo-200">
                    ...
                    <a href="register.php" class="text-white font-semibold hover:text-indigo-300 underline">Create one now</a>
                </p>
            </div>
        </div>
    </div>
